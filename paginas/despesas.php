				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Tipo Despesa</label>
								<select type="text" class="form-control sel2" id="tipo_despesa" name="tipo_despesa" style="width:100%">

									<?php
									$query = $pdo->query("SELECT * FROM tipo_despesas ORDER BY nome desc");
									...
									if ($total_reg > 0) {
										...
										echo '<option value="0">Cadastre um tipo de Despesa</option>';
									}
									?>
								</select>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div id="divImg">
								<img src="img/despesas/sem-foto.jpg" width="80px" id="target" class="mt-2">
							</div>
						</div>
...
<div class="modal fade" tabindex="-1" id="modalRelatorio">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary">Relatório de Despesas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="../gestao_financeira/rel/relDespesas_class.php" method="POST" target="_blank">   
            <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select mt-1" name="ordenacao">
								...
								<option value="tipo_despesa">Tipo Despesa</option>		
                            </select>
                        </div>
                    </div>
