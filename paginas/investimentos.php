...
<div class="" style="margin:20px;">
	<a class="btn btn-primary" onclick="inserir()" class="btn btn-primary btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Investimento</a>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Tipo Investimento</label>
								<select type="text" class="form-control sel2" id="tipo_investimento" name="tipo_investimento" style="width:100%">

									<?php
									$query = $pdo->query("SELECT * FROM tipo_investimento ORDER BY nome desc");
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div id="divImg">
								<img src="img/investimentos/sem-foto.jpg" width="80px" id="target" class="mt-2">
							</div>
						</div>
...
<div class="modal fade" tabindex="-1" id="modalRelatorio">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title text-primary">Relatório de Investimentos</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form action="../gestao_financeira/rel/relInvestimentos_class.php" method="POST" target="_blank">
				<div class="modal-body">
						...
						<div class="col-md-6">
							...
							<div class="form-group mb-3">
								...
								<select class="form-select mt-1" name="ordenacao">
									...
									<option value="tipo_receita">Tipo Investimento</option>
								</select>
							</div>
						</div>
