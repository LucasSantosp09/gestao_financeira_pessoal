...
<body>
	...
	<div class="container">
		<div align="center" class="titulo">
			<span class="titulorel">Relatório de Receitas</span>
		</div>
		...
		<table class='table' width='100%' cellspacing='0' cellpadding='3'>
			...
			<?php
			$query = $pdo->query("SELECT * FROM Receitas where data >= '$dataInicial' and data <= '$dataFinal' and id_usuario = '$usu' order by $ordenacao ");
			...
			for ($i = 0; $i < @count($res); $i++) {
				...
				$nome = $res[$i]['nome'];
				$data = $res[$i]['data'];
				$data_receita_formatada = implode('/', array_reverse(explode('-', $res[$i]['data'])));;
			...
			?>
				...
				<tr class="">
					...
					<td><?php echo $nome_tipo_despesa ?> </td>
