...
<body>
	...
	<div class="container">
		<div align="center" class="titulo">
			<span class="titulorel">Relatório de Despesas</span>
		</div>
		...
		<table class='table' width='100%' cellspacing='0' cellpadding='3'>
			...
			<?php
			$query = $pdo->query("SELECT * FROM despesas where data >= '$dataInicial' and data <= '$dataFinal' and id_usuario = '$usu' order by $ordenacao ");
			...
			for ($i = 0; $i < @count($res); $i++) {
				...
				$nome = $res[$i]['nome'];
				$data = $res[$i]['data'];
				$data_despesa_formatada = implode('/', array_reverse(explode('-', $res[$i]['data'])));;
